...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('UpdateSong') }}" method="POST" class="needs-validation" novalidate>        
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                       id="name" name="name" value="{{ old('name', $song->name) }}" required>
                @error('name')
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control @error('release_date') is-invalid @enderror" 
                       id="release_date" name="release_date" value="{{ old('release_date', $song->release_date) }}" required>
                @error('release_date')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
